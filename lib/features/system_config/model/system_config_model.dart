...
class SystemConfigModel {
  ...
  SystemConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    multiMatchWrongAnswerDeductScore =
        int.parse(json['multi_match_wrong_answer_deduct_score'] as String);
    multiMatchCorrectAnswerCreditScore =
        int.parse(json['multi_match_correct_answer_credit_score'] as String);

    guessTheWordHintDeductCoins =
        int.parse(json['guess_the_word_hint_deduct_coin'] as String);
  }
