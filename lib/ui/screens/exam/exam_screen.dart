...
class _ExamScreenState extends State<ExamScreen> with WidgetsBindingObserver {
  ...
  late final bool isExamLatexModeEnabled =
      context.read<SystemConfigCubit>().isLatexEnabled(QuizTypes.exam);
  ...
  void submitResult() {
    context.read<ExamCubit>().submitResult(
          ...
          totalDuration:
              timerKey.currentState?.secondsTookToCompleteExam().toString() ??
                  '0',
        );
  }
    ...
    Navigator.of(context).pushReplacementNamed(
      ...
      arguments: {
        ...
        'timeTakenToCompleteQuiz':
            timerKey.currentState?.secondsTookToCompleteExam().toDouble(),
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final constraints = BoxConstraints(
                ...
                maxHeight:
                    context.height * UiUtils.questionContainerHeightPercentage,
              );
