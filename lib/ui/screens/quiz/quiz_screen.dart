...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  late final quizDuration =
      context.read<SystemConfigCubit>().quizTimer(widget.quizType);
  ...
  Widget build(BuildContext context) {
    ...
    final progress = currentQuestionIndex /
        (quesCubit.questions().isNotEmpty ? quesCubit.questions().length : 1);
        ...
        builder: (context, state) {
          ...
          return PopScope(
            ...
            child: Scaffold(
              body: Column(
                children: [
                  /// 🔴 Top Red Container with Quiz Info
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${context.read<QuestionsCubit>().questions().length} Questions',
                        ...
                        LinearProgressIndicator(
                          ...
                          color: const Color(0xFF920D0D),
                        ),
                        const SizedBox(height: 10),
                        Align(
                          alignment: Alignment.centerRight,
                          child: Text(
                            // '$currentQuestionIndex/${context.read<QuestionsCubit>().questions().length}',
                            '$currentQuestionIndex/${context.read<QuestionsCubit>().questions().length}',
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 14,
                  ...
                  /// 📦 Questions Container with Overlays
                  Expanded(
                    child: Stack(
                      children: [
                        Align(
                          ...
                          child: QuestionsContainer(
                            ...
                            quizType: widget.quizType,
                            answerMode:
                                context.read<SystemConfigCubit>().answerMode,
                          ...
                          children: [
                            ...
                            AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                final remaining = timerAnimationController.duration! *
                                    (1.0 - timerAnimationController.value); // 👈 Reverse calculation

                                final minutes = remaining.inMinutes.remainder(30).toString().padLeft(2, '0');
                                final seconds = remaining.inSeconds.remainder(30).toString().padLeft(2, '0');
